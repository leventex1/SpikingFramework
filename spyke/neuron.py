...
class Neuron(ABC, Node):
    ...
    - self.on_fireing_callback: None | (neuron: Neuron) -> None, is a callback function that gets called when the self.on_fireing is called.
    ...
    def __init__(self,
            ...
            on_fireing_callback: None | Callable[['Neuron'], None]) -> None:
        super().__init__()
...
class SpikingNeuron(Neuron):
    ...
    def __init__(self, 
        ...
        on_fireing_callback: None | Callable[['SpikingNeuron'], None] = None) -> None:
        super().__init__(reset_value, membrane_value, on_fireing_callback)
